...
// console.log('Before converting result to uppercase:' + answer);
var answer = answer.toUpperCase();
// console.log('After converting result to uppercase:' + answer);
    if (answer == 'ALASTAIR') {
...
// console.log('After converting result to uppercase:' + goodbye);
    if (goodbye == 'ALASTAIR') {
